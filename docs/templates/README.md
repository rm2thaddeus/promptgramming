...
MCP and Rules
- Follow project rules in `.cursor/rules/*.mdc` (e.g., debugging, testing, docs, MCP usage).
...
- `PROFILE.yaml` – user profile and collaboration preferences (Phase 0)
- `CONTEXT.md` – background, goals, and constraints (Phase 0)
- `IDEA_NOTE.md` – structured idea and goals (Phase 1)
- `POC_PLAN.md` – research, spikes, architecture (Phase 2)
- `PRD.md` – product requirements and acceptance criteria (Phase 3)
- `agents.md` – AI roles/personas used during the project (Phase 3)
- `.cursor/rules/*.mdc` – project-specific rules and playbooks
